<template>
  <div class="button-gsap">
      <button class="truck-button">
          <span class="default">立即下单</span>
          <span class="success">
              订单完成
        ...
        button.addEventListener('click', e => {
            ...
            if(!button.classList.contains('done')) {
                if(!button.classList.contains('animation')) {
                    if(this.model.name == '' || this.model.phone == '' || this.model.beginRegion == '' || this.model.endRegion == '') {
                      this.$Message.error('内容不能为空')
                    } else if(PHONE.test(this.model.phone)){
                      ...
                      this.$Message.success('订单已完成，请耐心等待客服联系，保持电话畅通!')
                    } else {
